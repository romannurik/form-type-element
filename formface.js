...
(function() {
  ...
  formFace.createInstance = function(text, options) {
    ...
    instance._padding = (options.padding === 0 || options.padding) || (DEFAULT_PADDING * instance._scale);
  ...
  Instance.prototype.draw = function() {
    ...
    if (this._theme.colorbg == 'transparent') {
  ...
  Instance.prototype._createCanvas = function() {
    ...
    this._canvas.style.width = (size.width / this._densityMultiplier) + 'px';
    this._canvas.style.height = (size.height / this._densityMultiplier) + 'px';
  };
